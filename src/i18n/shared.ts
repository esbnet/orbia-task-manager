...
const dictionaries: Record<Locale, Dict> = {
    "pt-BR": {
        ...
        noTasks: {
            noTaskAvailable: "Nenhuma tarefa disponível",
            noTaskAvailableDescription: "Comece criando sua primeira tarefa para organizar sua rotina.",
            createTask: "Criar primeira tarefa",
        },
        forms: {
            title: "Título",
            ...
            editDetails: "Edite os detalhes da tarefa",
        ...
        settings: {
            ...
            homeLayoutDefault: "Padrão do Orbia",
            homeLayoutAlternative: "Alternativo (inspirado no OpenClaw)",
            homeLayoutDescription: "Escolha qual visual de Home será carregado por padrão para sua conta.",
    ...
    "en-US": {
        ...
        noTasks: {
            noTaskAvailable: "No tasks available.",
            noTaskAvailableDescription: "Start by creating your first task to organize your routine.",
            createTask: "Create first task.",
        },
        forms: {
            title: "Title",
        ...
        settings: {
            ...
            homeLayoutDefault: "Orbia default",
            homeLayoutAlternative: "Alternative (OpenClaw-inspired)",
            homeLayoutDescription: "Choose which Home visual should load by default for your account.",
            timezone: "Timezone",
    ...
    "es-ES": {
        ...
        noTasks: {
            noTaskAvailable: "No hay tareas disponibles.",
            noTaskAvailableDescription: "Empieza creando tu primera tarea para organizar tu rutina.",
            createTask: "Crear la primera tarea",
        },
        forms: {
            title: "Título",
            ...
            editDetails: "Editar detalles de la tarea",
        ...
        settings: {
            ...
            homeLayoutDefault: "Predeterminado de Orbia",
            homeLayoutAlternative: "Alternativo (inspirado en OpenClaw)",
            homeLayoutDescription: "Elige qué visual de Inicio se cargará por defecto para tu cuenta.",
