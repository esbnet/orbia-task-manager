import { UpdateGoalUseCase } from "@/application/use-cases/use-cases/goal/update-goal/update-goal-use-case";
...
describe("UpdateGoalUseCase", () => {
	...
	beforeEach(() => {
		...
		useCase = new UpdateGoalUseCase(dailyRepository);
	});
	...
	it("deve executar o caso de uso com sucesso", async () => {
		// TODO: Implementar teste específico para UpdateGoalUseCase
