import { CreateGoalUseCase } from "@/application/use-cases/use-cases/goal/create-goal/create-goal-use-case";
...
describe("CreateGoalUseCase", () => {
	...
	beforeEach(() => {
		...
		useCase = new CreateGoalUseCase(dailyRepository);
	});
	...
	it("deve executar o caso de uso com sucesso", async () => {
		// TODO: Implementar teste específico para CreateGoalUseCase
