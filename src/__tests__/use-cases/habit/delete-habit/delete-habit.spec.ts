import { DeleteHabitUseCase } from "@/application/use-cases/use-cases/habit/delete-habit/delete-habit-use-case";
...
describe("DeleteHabitUseCase", () => {
	...
	beforeEach(() => {
		...
		useCase = new DeleteHabitUseCase(dailyRepository);
	});
	...
	it("deve executar o caso de uso com sucesso", async () => {
		// TODO: Implementar teste específico para DeleteHabitUseCase
