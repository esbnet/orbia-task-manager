import { CreateTagUseCase } from "@/application/use-cases/use-cases/tag/create-tag/create-tag-use-case";
...
describe("CreateTagUseCase", () => {
	...
	beforeEach(() => {
		...
		useCase = new CreateTagUseCase(dailyRepository);
	});
	...
	it("deve executar o caso de uso com sucesso", async () => {
		// TODO: Implementar teste específico para CreateTagUseCase
