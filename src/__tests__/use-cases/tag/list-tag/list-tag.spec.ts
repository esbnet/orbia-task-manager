...
describe("ListTagUseCase", () => {
	...
	it("deve executar o caso de uso com sucesso", async () => {
		// TODO: Implementar teste específico para ListTagUseCase
