import { UpdateTagUseCase } from "@/application/use-cases/use-cases/tag/update-tag/update-tag-use-case";
...
describe("UpdateTagUseCase", () => {
	...
	beforeEach(() => {
		...
		useCase = new UpdateTagUseCase(dailyRepository);
	});
	...
	it("deve executar o caso de uso com sucesso", async () => {
		// TODO: Implementar teste específico para UpdateTagUseCase
