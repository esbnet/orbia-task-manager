import { DeleteTagUseCase } from "@/application/use-cases/use-cases/tag/delete-tag/delete-tag-use-case";
...
describe("DeleteTagUseCase", () => {
	...
	beforeEach(() => {
		...
		useCase = new DeleteTagUseCase(dailyRepository);
	});
	...
	it("deve executar o caso de uso com sucesso", async () => {
		// TODO: Implementar teste específico para DeleteTagUseCase
