---
description: "Use quando criar ou alterar endpoints Next.js em src/app/api. Inclui padrao de auth, validacao, arquitetura limpa e compatibilidade de rotas singular/plural."
...
- Tratar erros sem vazar detalhes sensiveis.
